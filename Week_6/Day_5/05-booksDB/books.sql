...
--above does the same things as INNERJOIN. we also made aliases for books and authors, by naming them b for books, and a for authors. 
...
select * from books where title = "Dracula"; --will select only the information where title = "Dracula"
--where always behaves as a filter

select * from books where title = "Dracula" and id = 6; --added 'and' statement, you can string on multiple search criterias

SELECT count(*) from books; --will display the amount of entries in the books table.
